        ...
        <div className="paymentOverview">
           ...
           {props.location && <Dropdown title="Shipping Address" content={[<p>{props.location.address}</p>,<p>{props.location.city}</p>,<p>{props.location.country}</p>,<p>{props.location.zipCode}</p>,<p className='change' onClick={() => props.goToStep(1)}>Change</p>]}/>}
            ...
            <div className='readTerms'>
                <Checkbox label={["I confirm that I have read and accepted Auction’s ",<a href='/terms'>terms and conditions</a>]}></Checkbox>
            </div>
            <div className='navigationButtons'>
                ...
                <div className="optionButtons" >
                    ...
                    <Button lable ={`Pay $${props.amount}`} buttonClass="purpleButton" onClick={() => navigate("/paymentComplete",{state:{product:props.product,amount:props.amount}})}></Button>
                </div>
