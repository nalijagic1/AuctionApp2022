    ...
    <div>
      <PathBar
        prop={{
          ...
          startPoint: "Home",
          endPoint: "Privacy and policy",
        }}
      />
      <div className="privacy">
        <h2>Privacy And Policy</h2>
        <p>
          This privacy policy ("policy") will help you understand how Auction
          ...
          Auction is committed to securing your data and keeping it
          confidential. Auction has done all in its power to prevent data theft,
          ...
          data is completely removed from our systems. Please note that cookies
          don't allow us to gain control of your computer in any way. They are
          strictly used to monitor which pages you find useful and which you do
          not so that we can provide a better experience for you. If you want to
          disable cookies, you can do it by accessing the settings of your
          internet browser. You can visit www.internetcookies.com, which
          ...
          on these links Auction is not held responsible for your data and
          ...
          more than happy to change this for you. Auction will not lease, sell
          or distribute your personal information to any third parties, unless
