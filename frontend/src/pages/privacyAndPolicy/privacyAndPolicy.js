...
function PrivacyAndPolicy() {
    return(
      ...
      <div className="privacy">
       ...
       <p>This privacy policy ("policy") will help you understand how Auction uses and protects the data you provide to us when you visit and use websites.
          <br/>
          ...
          Auction is committed to securing your data and keeping it confidential. Auction has done all in its
          ...
          Our website contains links that lead to other websites. If you click on these links Auction is not
          ...
          Auction will not lease, sell or distribute your personal information to any third parties, unless we
